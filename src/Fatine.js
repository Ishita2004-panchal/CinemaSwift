    ...
    return (
        <div className="main bg-light ">
            <div className="banneru bg-dark position-relative">
                <img src="faatineb.jpeg" className="cover w-100" alt="..." />

                <div className="details ">
                    <img src="faatine.jpg" className="overlay-image" alt="..." />
                </div>

                <h2 className="text-white">Faati ne?</h2>
                ...
                <div className='row'>
                    ...
                    <div className='col-md-8'>
                        <div className="info">
                            ...
                            <p className="">To save their job and get their life back, two goofy police officers must spend a night at a haunted mansion.</p>
                        </div>
                    </div>
                    <div className='col-md-2'></div>
                </div>
