    ...
    return (
        <div className="main bg-light ">
            <div className="banneru bg-dark position-relative">
                <img src="kaashib.jpeg" className="cover w-100" alt="..." />

                <div className="details ">
                    <img src="kaashi.jpeg" className="overlay-image" alt="..." />
                </div>

                <h2 className="text-white">Kaashi Raghav</h2>
                ...
                <div className='row'>
                    ...
                    <div className='col-md-8'>
                        <div className="info">
                            ...
                            <p className=" w-75 mx-5">A lost child, a haunted past, and a tragic love story: Kaashi-Raaghav unravels a journey through betrayal, redemption, and the flames of an unforgiving society.</p>
                        </div>
                    </div>
                    <div className='col-md-2'></div>
                </div>
